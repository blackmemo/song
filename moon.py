...
def bul(_, message):
    ...
    try:
        ...
        message.reply_audio(audio_file, caption=rep, parse_mode='md',quote=False, title=title, duration=dur, reply_markup=keyboard, thumb=thumb_name, performer="@YouTubeVcProBot"),
        ...
        m.delete()
        bot.send_audio(chat_id=Config.PLAYLIST_ID, audio=audio_file, caption=mel, performer="@YouTubeVcProBot", parse_mode='md', title=title, duration=dur, thumb=thumb_name,reply_markup=keyboard),
        keyboard = InlineKeyboardMarkup(
           [
                [
                    InlineKeyboardButton(
